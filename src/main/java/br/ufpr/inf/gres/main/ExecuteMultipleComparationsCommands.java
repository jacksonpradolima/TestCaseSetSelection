...
public class ExecuteMultipleComparationsCommands {

    @Parameter(names = {"-help", "-h"}, help = true)
    public boolean help;

    @Parameter(names = {"--folder", "-f"}, description = "The path to the problem file.", required = true)
    ...
    public String toString() {
        return "ExecuteMultipleComparationsCommands = [folder=" + folder + ", dataSeparator=" + dataSeparator + ", skipHeader=" + skipHeader + ", runs=" + runs
